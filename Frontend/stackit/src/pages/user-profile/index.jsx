...
const UserProfile = () => {
  ...
  useEffect(() => {
    const mockUser = {
      ...
      bio: `Full-stack developer with 5+ years of experience in React, Node.js, and cloud technologies. Passionate about clean code, performance optimization, and helping others learn programming. Always excited to tackle challenging problems and share knowledge with the community.`,
    ...
    const mockQuestions = [
      {
        id: 1,
        title: "How to implement efficient state management in large React applications?",
        excerpt: "I\'m working on a large React application with multiple components that need to share state. What are the best practices for state management?",
      ...
      },
      {
        ...
        excerpt: "What\'s the recommended approach for handling API errors gracefully in React apps? Should I use try-catch blocks or error boundaries?",
      ...
      },
      {
        ...
        excerpt: "I\'m struggling with TypeScript generic constraints when creating reusable React components. How can I properly type generic props?",
    ...
    const mockAnswers = [
      {
        ...
        excerpt: "You can use React.memo for functional components and useMemo/useCallback hooks to prevent unnecessary re-renders. Here\'s a comprehensive approach...",
      ...
      },
      {
        ...
        excerpt: "I recommend using react-hook-form with yup for schema validation. It provides excellent performance and developer experience...",
      ...
      },
      {
        ...
        excerpt: "Cleanup functions are essential for preventing memory leaks. They run when the component unmounts or before the effect runs again...",
  ...
  const handleActivityClick = (activity) => {
    if (activity.type === 'question' || activity.type === 'answer' || activity.type === 'comment') {
      window.location.href = '/question-detail-answers';
    }
  };
            ...
            {questions.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">
                  {isOwnProfile ? "You haven't asked any questions yet." : "This user hasn't asked any questions yet."}
                </p>
                {isOwnProfile && (
                  <Button
          ...
          <div className="space-y-4">
            {answers.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">
                  {isOwnProfile ? "You haven't answered any questions yet." : "This user hasn't answered any questions yet."}
                </p>
                {isOwnProfile && (
                  <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {badges.length > 0 ? (
              ...
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-muted-foreground">
                  {isOwnProfile ? "Earn badges by participating in the community." : "This user hasn't earned any badges yet."}
                </p>
              </div>
            )}
          </div>
